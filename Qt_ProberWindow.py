...
class ProberWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, MainGI, QFont=None, QMargin=None, QSpacing=None, width=300, height=200, icon=None, title="Prober"):
        ...
        self.MoveXWid = ChuckScopeEntry(self._main, self.MainGI, "MoveX", maxLength=self.maxMoveLength, command=self.writeMoveX)
        ...
        self.MoveYWid = ChuckScopeEntry(self._main, self.MainGI, "MoveY", maxLength=self.maxMoveLength, command=self.writeMoveY)
        ...
        self.MoveXIndexWid = ChuckScopeEntry(self._main, self.MainGI, "MoveXIndex", maxLength=self.maxMoveIndexLength, command=self.writeMoveIndexX)
        ...
        self.MoveYIndexWid = ChuckScopeEntry(self._main, self.MainGI, "MoveYIndex", maxLength=self.maxMoveIndexLength, command=self.writeMoveIndexY)
        ...
        self.VelocityEntryWid = ChuckScopeEntry(self._main, self.MainGI, "Velocity", "^[1-9]$|^[1-9][0-9]$|^(100)$", 3, command=self.writeVelocity)
